...
const CAROUSEL_CONTENTS = [
  ...
  },
  {
    title: "Bunny Cafe",
    description:
      "Bunny Cafe is an example of a user-created restaurant, featuring our bunny, Kuro",
    link: "#/restaurants/20",
  ...
  },
  {
    title: "AppAcademy",
    description:
      "This site was created by Jonathan Wong as a Full-Stack clone during his time at AppAcademy.",
  ...
  },
  {
    title: "Restaurants",
    description:
      "These are all restaurants local to my current residence, which is Union, New Jersey",
  ...
  renderSlide(slide, index) {
    if (slide.link) {
      return (
        ...
        >
          <div
            className={`carousel-inner ${slide.className}`}
  ...
  render() {
    return (
      <div className="carousel-container-outer">
        <button onClick={() => this.nextSlide("Left")}>
        ...
        <button onClick={() => this.nextSlide("Right")}>
