      ...
      return (
        <div id="food-modal-content">
          ...
          <div id="food-modal-item">
            ...
            <div id="food-modal-calorie-warning">2,000 calories a day is used for general nutrition advice, but calorie needs vary. Additional nutrition information available upon request.</div>
          </div>
          <div id="food-modal-controls">
            <div id="food-modal-quant-control">
              <button onClick={() => this.decrement()} className="food-modal-control-button">-</button>
              <div id="food-modal-quantity">{this.state.quantity}</div>
              <button onClick={() => this.increment()} className="food-modal-control-button">+</button>
            </div>
            <button id="food-modal-add-order">
              <div id="food-modal-add-left">Add {this.state.quantity} to order</div>
              <div id="food-modal-add-right">${Util.priceMultiple(this.state.quantity, item.item_price)}</div>
            </button>
          </div>
        </div>
      )
